...
class MmuMachine:
    ...
    def __init__(self, config):
        ...
        self.selector_type = config.getchoice('selector_type', {o: o for o in ['LinearSelector', 'VirtualSelector', 'MacroSelector', 'RotarySelector', 'ServoSelector', 'IndexedSelector', 'StepperIdlerSelector']}, selector_type)
