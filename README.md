...
- 🔄 **Idler behavior explained:** [IDLER_BEHAVIOR.md](IDLER_BEHAVIOR.md) - How rotary idler with bearings works
...
- 🧪 **Testing:** [test/TESTING.md](test/TESTING.md) - How to run unit tests
